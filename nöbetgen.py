...
def çalıştır():
 çıktı=""
 for dosya in dizindekiXLSler: VT.çekilenVeri.update(okuveyaz.XLSoku(dosya))
...
class GUI:
 ...
 def __init__(self,
              ...
              ekle="",
              sil="",
              sonüyeler=okuveyaz.XLSoku(max(dizindekiXLSler))#son listeyi belirlemek için
              ):
  sg.theme('DarkAmber')   
